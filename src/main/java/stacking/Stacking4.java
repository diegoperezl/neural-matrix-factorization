...
public class Stacking4 extends Recommender {
     ...
     */
    public Stacking4(DataModel datamodel, Map<String, Object> params) {
        this(
                datamodel,
    ...
    public Stacking4(
        ...
        for (String recommender : recommenders.keySet()) {
            builder
                    .addLayer(
                            recommender + "UserLayer",
                            new DenseLayer.Builder()
                                    .nIn(datamodel.getNumberOfUsers())
                                    .nOut(1)
                    ...
                    .addLayer(
                            ...
                            "item")
                    .addVertex(
                            recommender + "LayerProduct",
                            new ElementWiseVertex(ElementWiseVertex.Op.Product),
                            recommender + "UserLayer",
                            recommender + "ItemLayer",
                            recommender);

            concatLayers[index] = recommender + "LayerProduct";
            index++;
        }
