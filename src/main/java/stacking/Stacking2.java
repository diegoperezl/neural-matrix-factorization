...
public class Stacking2 extends Recommender {
     ...
     */
    public Stacking2(DataModel datamodel, Map<String, Object> params) {
        this(
                datamodel,
            ...
            builder
                    .addLayer(
                            ...
                            new DenseLayer.Builder()
                                    .nIn(datamodel.getNumberOfUsers() + datamodel.getNumberOfItems())
                                    .nOut(1)
